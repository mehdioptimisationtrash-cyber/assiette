...
- 2026-09-24 : Mehdi ne voyait pas la carte Google Sheets (iPhone resté sur l'ancienne version, cache d'abord). Service worker passé en réseau d'abord + rechargement auto + numéro de version en bas du Profil (v6).
