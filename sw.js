...
const CACHE_VERSION = 'assiette-v1';
const SHELL = [
  ...
  'js/scanner.js', 'js/vision.js',
  'js/views/journal.js', 'js/views/add.js', 'js/views/product.js', 'js/views/photo.js',
...
self.addEventListener('fetch', (event) => {
  ...
  if (!isOwn && !isLib) return; // API Open Food Facts / Claude : toujours en direct
  event.respondWith(
